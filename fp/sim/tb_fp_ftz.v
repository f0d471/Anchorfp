...
// TB: tb_fp_ftz
//
// DESCRIPTION: fp32_add 与 fp32_mul_pipe 的 FTZ 语义判据，定向用例加全域随机。
//
// NOTE:
//   1. 18 条定向覆盖最小正 denormal、最大 denormal、Inf x denormal 与零符号
//   2. 加乘各 20 万条全域随机，期望值按 FTZ 契约算
//==============================================================================================//
module tb_fp_ftz;
    reg clk=0, rst_n=0;
    always #5 clk=~clk;
